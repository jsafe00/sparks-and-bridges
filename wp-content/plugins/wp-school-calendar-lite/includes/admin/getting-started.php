...
class WP_School_Calendar_Getting_Started {
    ...
    public function admin_menu() {
        add_submenu_page( 'edit.php?post_type=important_date', __( 'Getting Started', 'wp-school-calendar' ), __( 'Getting Started', 'wp-school-calendar' ), 'manage_options', 'wpsc-getting-started', array( $this, 'admin_page' ) );
    }
            ...
            <div class="wpsc-container">
                ...
                <div class="wpsc-sidebar">
                    <div class="wpsc-widget">
                        ...
                        <p><a class="wpsc-button" href="//wpschoolcalendar.com/demo/" target="_blank"><?php echo esc_html__( 'See Live Demo', 'wp-school-calendar' ) ?></a></p>
                    </div>
                    ...
                    <div class="wpsc-widget">
                        ...
                        <p><a class="wpsc-button" href="//wpschoolcalendar.com/getting-started/" target="_blank"><?php echo esc_html__( 'See Documentation', 'wp-school-calendar' ) ?></a></p>
                    </div>
                </div>
                ...
                <p><?php echo __( 'Then the calendar will be displayed on the page that you specify.', 'wp-school-calendar' ) ?></p>
                ...
                <p><?php echo __( 'This will add the WP School Calendar block to the editor screen. You can now publish the page and visit your website to see your calendar in action.', 'wp-school-calendar' ) ?></p>
                
                <p><?php echo __( 'You can also use shortcode to display calendar on your site. All you will need to do is add <code>[wp_school_calendar]</code> to any page or post.', 'wp-school-calendar' ) ?></p>
                
                <p><?php printf( __( 'The next step, go to <a href="%s">School Calendar &gt; Settings</a> to change the appearance of your calendar and <a href="%s">School Calendar &gt; Important Dates</a> to add some important dates to your calendar.', 'wp-school-calendar' ), admin_url( 'edit.php?post_type=important_date&page=wpsc-settings' ), admin_url( 'edit.php?post_type=important_date' ) ) ?></p>
                ...
                <p><?php printf( __( 'Yes. You can look the demo page <a href="%s" target="_blank">here</a>.', 'wp-school-calendar' ), 'https://wpschoolcalendar.com/demo/' ) ?></p>
