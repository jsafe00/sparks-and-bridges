...
class WP_School_Calendar_Categories {
    ...
    public function admin_menu() {
        add_submenu_page( 'edit.php?post_type=important_date', __( 'Categories', 'wp-school-calendar' ), __( 'Categories', 'wp-school-calendar' ), 'manage_options', 'wpsc-category', array( $this, 'admin_page' ) );
    }
    ...
    private function edit() {
		...
		?>
		<form method="post" action="<?php echo admin_url( 'edit.php?post_type=important_date&page=wpsc-category&edit=' . intval( $_REQUEST['edit'] ) ); ?>">
                                ...
                                <tr class="inactive">
                                    ...
                                    <td class="plugin-title column-primary">
                                        ...
                                        <div class="row-actions">
                                            <span class="edit"><a href="<?php echo admin_url( 'edit.php?post_type=important_date&amp;page=wpsc-category&edit=' . intval( $category['category_id'] ) ); ?>"><?php _e( 'Edit', 'wp-school-calendar' ); ?></a></span>
                                            <?php if ( intval( $default_category ) !== intval( $category['category_id'] ) ): ?>
                                            <span class="delete"> | <a href="<?php echo wp_nonce_url( admin_url( 'edit.php?post_type=important_date&page=wpsc-category&delete=' . intval( $category['category_id'] ) ), 'category_delete-' . $category['category_id'] ); ?>"><?php _e( 'Delete', 'wp-school-calendar' ); ?></a></span> 
                                            <?php endif ?>
                                        </div>
                                    </td>
			...
			<div id="col-left">
				<div class="col-wrap">
					<div class="form-wrap">
						...
						<form method="post" action="<?php echo admin_url( 'edit.php?post_type=important_date&page=wpsc-category' ) ?>">
